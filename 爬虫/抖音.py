...
class DouYin(object):
    def __init__(self, width=500, height=300):
        ...
        self.driver = Browser(driver_name='chrome', executable_path='C:\chromedriver_win32\chromedriver.exe',
    ...
    def get_video_urls(self, user_id):
        ...
        while unique_id != user_id:
            ...
            #     user_url = "https://api.amemv.com/aweme/v1/aweme/post/?user_id={}&max_cursor=0&count={}".format(uid,aweme_count)
            user_url = 'https://www.amemv.com/aweme/v1/aweme/post/?user_id=%s&max_cursor=0&count=%s' % (
            uid, aweme_count)
